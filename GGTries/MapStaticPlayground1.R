...
# countyIDs <- seq_along(unique(dsLocation$region))

#   sp <- map2SpatialPolygons(dsLocation, IDs=countyIDs,  proj4string=CRS(" +proj=longlat +datum=NAD83 +ellps=GRS80 +towgs84=0,0,0"))
